...
class AuthController extends BaseController {
  ...
  //       ));
	...
	public function getSignup()
	{
		...
		// Show the page
		return View::make('frontend.auth.signup', compact('kabupatens'));
	}
	...
	public function postSignup()
	{
		...
		try
		{
			...
			$user = Sentry::register(array(
				'ktp'		 => Input::get('ktp'),
				'kabupaten'	 => Input::get('namaKabupaten'),
				...
				'permissions' => array('superuser' => '-1', 'admin' => '-1'),
			));
			...
			return Redirect::back()->with('success', 'pendaftaran berhasil, mohon tunggu akun di konfirmasi oleh admin');
		}
		catch (Cartalyst\Sentry\Users\UserExistsException $e)
		{
			$this->messageBag->add('email', 'akun sudah ada');
		}
