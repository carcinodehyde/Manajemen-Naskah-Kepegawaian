                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Edit Data Jenis Dokumen
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="jenisdokumen" id="jenisdokumen" value="{{ Input::old('jenisdokumen', $jenis->jenisdokumen) }}">
                                        </div>
