...
<div class="page-header">
        <h3>
                ...
                <div class="pull-right">
                        <a href="{{ route('Dokumen', $idpegawai) }}" class="btn btn-small btn-inverse"><i class="icon-circle-arrow-left icon-white"></i> Kembali</a>
                </div>
        </h3>
</div>
<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Input Data Dokumen
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                            ...
                                            @foreach($jenis as $j)
                                                    <option value="{{ $j->idjenisdokumen }}">{{ $j->jenisdokumen }}</option>
                                            @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="control-group">
                                                <div class="controls">
                                                        <a class="btn btn-link" href="{{ route('Dokumen', $idpegawai) }}">&laquo; Batal</a>
